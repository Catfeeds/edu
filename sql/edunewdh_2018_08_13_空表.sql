...
Source Database       : edunewdh_null

Target Server Type    : MYSQL
Target Server Version : 50719
File Encoding         : 65001

Date: 2018-08-13 11:13:28
*/
...
CREATE TABLE `edu_class` (
  ...
  `code` int(10) NOT NULL COMMENT '班级号',
...
CREATE TABLE `edu_courseware` (
  ...
  `flag` int(1) NOT NULL DEFAULT '0' COMMENT '0:课程或课堂|1:章节',
  PRIMARY KEY (`id`),
...
CREATE TABLE `edu_exam_answer` (
  ...
  `questionid` char(32) COLLATE utf8_bin NOT NULL COMMENT '所在题id',
  `qtype` varchar(50) COLLATE utf8_bin NOT NULL COMMENT '题型',
  `answer` text COLLATE utf8_bin NOT NULL COMMENT '答案',
  `answerformat` tinyint(2) NOT NULL,
  `fraction` decimal(12,7) DEFAULT '0.0000000' COMMENT '正确答案标记',
  `tab` varchar(2) COLLATE utf8_bin DEFAULT NULL COMMENT '答案选项符号',
  `img` varchar(128) COLLATE utf8_bin DEFAULT NULL COMMENT '图片id',
  `status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '答案状态',
  `createbyid` char(32) COLLATE utf8_bin DEFAULT NULL COMMENT '创建者id',
  `modifiedbyid` char(32) COLLATE utf8_bin DEFAULT NULL COMMENT '修改者id',
  `timecreated` bigint(10) NOT NULL COMMENT '创建时间',
  `timemodified` bigint(10) DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `edu_exam_classroom_question_attempt_step_data` (
  ...
  `seq` int(3) NOT NULL DEFAULT '1' COMMENT '浣滅瓟娆℃暟',
  PRIMARY KEY (`id`),
...
CREATE TABLE `edu_exam_classroom_quiz` (
  ...
  `timeclose` bigint(10) DEFAULT NULL COMMENT '试卷结束时间',
...
CREATE TABLE `edu_exam_question` (
  `id` char(32) COLLATE utf8_bin NOT NULL,
  `pid` char(32) COLLATE utf8_bin DEFAULT '' COMMENT '题父id',
  `parentstr` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '0,' COMMENT '树结构',
  `code` varchar(10) COLLATE utf8_bin DEFAULT '0' COMMENT '试题随机码',
  `qtype` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '题类型',
  `seq` bigint(10) DEFAULT '0' COMMENT '娣诲姞棰樼殑椤哄簭',
  `courseid` char(32) COLLATE utf8_bin NOT NULL COMMENT '试题所在课程id',
  `sectionid` char(32) COLLATE utf8_bin NOT NULL COMMENT '试题所在课程章id',
  `sectionsid` char(32) COLLATE utf8_bin DEFAULT NULL COMMENT '试题所在课程节id',
  `name` varchar(255) COLLATE utf8_bin NOT NULL COMMENT '试题名生成的试题简介',
  `questiontext` text COLLATE utf8_bin NOT NULL COMMENT '试题名',
  `questiontextformat` tinyint(2) DEFAULT NULL,
  `generalfeedback` text COLLATE utf8_bin COMMENT '试题解析',
  `generalfeedbackformat` tinyint(2) DEFAULT NULL,
  `img` text COLLATE utf8_bin COMMENT '图片id  以逗号分隔',
  `createbyid` char(32) COLLATE utf8_bin DEFAULT NULL COMMENT '试题创建者id',
  `modifiedbyid` char(32) COLLATE utf8_bin DEFAULT NULL COMMENT '试题修改者id',
...
-- ----------------------------
INSERT INTO `edu_organization` VALUES ('B608AA535E0EC9C5DDBC8548AF39D4CB', '001', '0', '0,', '1', '1', '最高机构', '510104', '百叶路一号', '1501569082', '0', '0', '1', '机构简介');
...
INSERT INTO `edu_role` VALUES ('46CFD0BFC1B9D3044718D9DAFDB1B59A', 'teacher', null, null, '1', '教师', '5');
...
INSERT INTO `edu_role_user` VALUES ('CA17F4BC63EC956487F921E5A0A52B33', 'E70589FB8C89ADD2C7E743D3A0A725FB');
...
-- Records of edu_user
-- ----------------------------
INSERT INTO `edu_user` VALUES ('B608AA535E0EC9C5A7BC8548AF39D4CC', 'admin', '管理员', '1', 'f21036661273118f993ac019a9a58fa5', '123456', '123456', '138546354@qq.ad', '12345678902', 'B608AA535E0EC9C5DDBC8548AF39D4CB', '高新西区百叶路一号', '127.0.0.1', null, '管理员', '1501569082', '0', '0', '4', null, '2015', '1534128956');
