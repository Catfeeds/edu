<template>
  <div id="test">
    ...
    <el-button type="primary" @click="submitForm('ruleForm')">立即创建</el-button>
    <hr>
    <el-form ref="addProform" :model="addProForm" :rules="addProForm.rules">
      ...
      <el-form-item label="专业编码" :label-width="formLabelWidth" prop="code">
        <el-input v-model="addProForm.code" auto-complete="off"></el-input>
      </el-form-item>
    ...
    <div slot="footer" class="dialog-footer">
      <el-button type="primary" @click="fnAddSubmit('addProform')">确 定</el-button>
    </div>
  </div>
</template>
